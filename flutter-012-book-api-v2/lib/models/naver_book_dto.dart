class NaverBookDto {
  ...
  // DtoToMap(JsonToMap)
// 데이터를 create, update 를 해야 하는 경우
// 주로 NoSQL DB에 저장할 때 Dto 데이터를 Map 형식으로 변환한다
// Map 형식으로 저장된 데이터는 JSON type으로 쉽게 변환이 가능하다
  // jsonToDto(jsonToMap)
  ...
  // openAPI 로 받은 JSON데이터를 DTO 객체로 변환시키는 method
  // DtoToJson(FromMap)
